...
import { faCirclePlay, faSun, faMoon } from '@fortawesome/free-regular-svg-icons'
  ...
  return (
      <div className={`${bg} ${text}`}>
        ...
        <header className="w-full flex justify-between p-5 border-b border-gray-800">
          <a href="#"><Image src={`/codeedit-logo-${type}.png`} alt="CodeEdit Logo" width={128} height={21} /></a>
          ...
          <nav className="flex space-x-3 items-center">
            ...
            <a href="#"><FontAwesomeIcon icon={darkMode ? faSun : faMoon} className="ml-2 w-6" onClick={() => setDarkMode(prev => !prev)}/></a>
          </nav>
        </header>

        <main className={styles.main}>
          <section className={`relative min-h-full w-full ${bg} bg-[center_bottom_-16rem] sm:bg-[center_bottom_-20rem] md:bg-[center_bottom_-25rem] lg:bg-[center_bottom_-25rem] bg-no-repeat bg-135% lg:bg-115% flex flex-col items-center`}>
            <div className="mt-16">
            ...
            <p className="text-gray-400 font-light text-xl lg:text-2xl mt-4">Open source, free forever.</p>
